      ...
      <div className='container'>
          <div className='intro'>
            <div className='intro-text'>
              <p>I am Avazjon Yusufjonov, a philosophy and economics master's student and full-stack developer based in Bayreuth, Germany. Primary technologies that I work with are React.js & Node.js to build web applications, and Numpy & Pandas for data analysis. <br/> You can contact me through:</p>
              <div>
